...
const Tooltip = observer(
	class SankeyTransitionTooltip extends React.Component {
		constructor() {
			super();
			this.textHeight = 14;
			this.topOffset = 10;
		...
		render() {
			...
			const rectHeight =
				this.props.line2 !== undefined ? this.textHeight * 2 + this.padding : this.textHeight + this.padding;
