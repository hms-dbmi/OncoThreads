				...
				const controller = (
					<span>
						...
						<InputNumber
							min={1}
							step={1}
							value={dataStore.patientGroupNum}
							size="small"
							onChange={dataStore.changePatientGroupNum}
						/>
					</span>
				);
								...
								<Card
									title={
										<span style={{ fontSize: '17px' }}>
											Overview{' '}
											<Tooltip title="transition among the identified states">
												<InfoCircleOutlined />
											</Tooltip>
										</span>
									}
							...
							<Col md={this.widthRatios[2]} sm={this.widthRatios[2]}>
								<Card
									title={
										<span style={{ fontSize: '17px' }}>
											Details{' '}
											<Tooltip title="detailed analysis of the cause of different state transitions">
												<InfoCircleOutlined />
											</Tooltip>
										</span>
									}
								...
								>
									<div
										...
										style={{ height: this.height, overflowY: 'auto' }}
									>
										<TransitionComparison
											width={this.comparisonWidth}
											height={this.height}
