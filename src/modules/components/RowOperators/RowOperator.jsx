 ...
 */
const RowOperator = inject(
	'rootStore',
	'uiStore',
	'undoRedoStore'
)(
	observer(
		class RowOperator extends React.Component {
			constructor(props) {
				super(props);
				...
				return (
					...
					>
						...
						<rect
							...
							onContextMenu={(e) =>
								this.props.showContextMenu(e, timepoint.globalIndex, variable.id, 'SORT')
							}
				...
				return (
					...
					>
						...
						<rect
							...
							onContextMenu={(e) =>
								this.props.showContextMenu(e, timepoint.globalIndex, variable.id, 'GROUP')
							}
							width={this.iconDimensions}
							height={this.iconDimensions}
							fill="none"
				...
				return (
					...
					>
						...
						<rect
							...
							onContextMenu={(e) =>
								this.props.showContextMenu(e, timepoint.globalIndex, variable.id, 'UNGROUP')
							}
							width={this.iconDimensions}
							height={this.iconDimensions}
							fill="none"
						...
						if (
							...
							const lineHeight =
								d.id === this.props.timepoint.primaryVariableId
									...
									: this.props.rootStore.visStore.secondaryHeight;
							...
							const iconStartX = 5; // Start position for icons
							let groupUngroup;
							...
							rowOperators.push(
								...
								>
									{highlightRect}
									{this.getSortIcon(this.props.timepoint, d, iconStartX, yPos)}
									{groupUngroup}
									{this.getDeleteIcon(
										this.props.timepoint,
										d,
										iconStartX + 2 * (iconWidth + iconGap),
										yPos
									)}
								</g>
							);
			...
			getRaelign() {
				const pos = (this.props.rootStore.visStore.getTPHeight(this.props.timepoint) - this.iconDimensions) / 2;
